        ...
        >
            ...
            <motion.header className="space-y-4" variants={pageItem}>
                <div className="text-2xl xl:text-3xl font-semibold flex flex-row items-center space-x-3 text-cs2 w-fit">
                    <FontAwesomeIcon icon={faMapLocationDot} /> <span>Economy Guide</span>
                </div>
                <p className="text-sm xl:text-base text-neutral-300 font-normal leading-relaxed">
                    Equip yourself with the knowledge to master the in-game economy in Counter Strike: Global Offensive. This guide provides essential strategies for managing finances effectively, including buy strategies for different rounds, save rounds, weapon purchasing tips, and economic decision-making in critical situations.
                </p>
            </motion.header>
